...
$username = "root"; // Substitua pelo seu usuario do banco
$password = 'P@$$w0rd'; // Substitua pela sua senha
...
// Verifica se o metodo de requisiçõa é post
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    // Ovtém os dados do formulário 
    $nome = $_POST['name'];
    $email = $_POST['email'];
    ...
    $stmt->bind_param("sss", $nome, $email, $senha); // 'sss' indica os parmetros são string
